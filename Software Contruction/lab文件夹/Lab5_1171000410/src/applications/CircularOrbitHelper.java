...
public class CircularOrbitHelper {
  ...
  private static EeIntimacyMap<Friend> E2E = new EeIntimacyMap<Friend>(); // 轨道物体间的映射
  private static ArrayList<ArrayList<Friend>> t2e = new ArrayList<
      ArrayList<Friend>>(); // 物体所在轨道
