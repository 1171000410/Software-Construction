...
public class Difference {
	...
	private ArrayList<Integer> specificTracksNumDifference = new ArrayList<Integer>(); //特定轨道物体数目差异
	...
	// 	all the difference in quantities >= 0  
	...
	public void printOtherDifference() {
		...
		for(int i = 1 ; i <= specificTracksNumDifference.size(); i++) {
			System.out.printf("轨道%d的物体数量差异：%d； 物体差异：%s\n", i , 
					specificTracksNumDifference.get(i-1) , objectsDifference.get(i-1));
		}
	}
