...
public class CircularOrbitHelper2 {
	...
	private static ArrayList<ArrayList<Electron>> T2E = new ArrayList<ArrayList<Electron>>(); // 物体所在轨道
	private static final double DEG_TO_RAD = Math.PI / 180;  // 度数 * this constant = 弧度
	private static int proton;  //质子数
	private static int neutron;  //中子数
	...
	public static void visualizes(@SuppressWarnings("rawtypes") CircularOrbit c) {
		...
		Nucleus nuc = (Nucleus) c.getCentralObject();
		proton = nuc.getP();
		neutron = nuc.getN();
	...
	public static class MyPanel extends JPanel {
		...
		private void drawArc(Graphics g) {
			...
			String str = "p:"+proton+" n:"+neutron;
			g2d.drawString(str, 370, 400);
			g2d.dispose();
		}
	}
}
